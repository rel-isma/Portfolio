...
export function MobileNavHeader({ onMenuClick }: MobileNavHeaderProps) {
  ...
  return (
    <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-md border-b border-border z-50 flex items-center justify-between px-4 shadow-sm">
      {/* Logo/Brand */}
