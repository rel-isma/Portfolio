...
import { Download, UserCheck, User, Home, Code, Briefcase, Mail, BrainCircuit, ChevronLeft, Bot, Sun, Moon, GraduationCap } from "lucide-react";
...
export function Sidebar({ isMobileOpen = false, setIsMobileOpen }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar - Always Expanded by Default */}
      <motion.aside
      ...
      {/* Mobile Sidebar - Sliding from Left with Blur Overlay */}
      <AnimatePresence>
        {isMobileOpen && (
          <>
            {/* Backdrop with Blur */}
